    ...
    <section id="experience" className="py-16 sm:py-24 px-4 max-w-4xl mx-auto bg-white dark:bg-[#0a0505]">
      ...
      >
        <h2 className="text-3xl sm:text-4xl font-heading font-bold mb-2">
          My <span className="text-crimson">Experience</span>
        </h2>
        <motion.div
          initial={{ scaleX: 0 }}
          ...
          <div className="space-y-8">
            {experience.map((exp, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="absolute left-0 top-1 w-8 h-8 rounded-full bggold flex items-center justify-center ring-4 ring-white dark:ring-[#050505]">
                  <div className="w-2 h-2 rounded-full bg-white" />
                </div>

                <div className="p-5 rounded-xl bg-gray-50 dark:bg-[#0f0a0a] card-base">
                  ...
                  <p className="text-sm text-crimson dark:text-crimson font-medium mb-2">{exp.organization}</p>
