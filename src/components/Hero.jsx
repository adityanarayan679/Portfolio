...
<section
    ...
    >
      <div
        className="absolute inset-0 z-0 bg-[#F6F6F6]"
        style={{
      ...
      <div className="absolute left-[40%] md:left-[38%] top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-crimson/20 to-transparent z-10" />
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 py-16">
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold leading-[1.1] mb-4"
          >
          ...
          <motion.div variants={itemVariants} className="flex items-center justify-end gap-3 mb-6">
            <div className="h-px flex-1 bg-gold" />
            <AnimatePresence mode="wait">
              <motion.span key={roleIndex} className="text-gold text-sm tracking-heraldic uppercase"
          ...
          <motion.p
            variants={itemVariants}
            className="text-base text-gray-500 max-w-lg ml-auto mb-8 leading-relaxed"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-col sm:flex-row items-end justify-end gap-4 mb-10"
          >
            <MagneticButton
              href="#projects"
              className="px-8 py-3 rounded-md bggold text-white font-semibold text-sm tracking-wide hover:scale-[1.02] hover:glow-gold-lg transition-all duration-300"
            >
              View Projects
            </MagneticButton>
            <MagneticButton
              ...
              className="px-8 py-3 rounded-md border border-crimson/50 text-crimson font-semibold text-sm tracking-wide hover:bg-crimson/10 hover:border-crimson transition-all duration-300"
            >
              Download CV
            </MagneticButton>
          </motion.div>
